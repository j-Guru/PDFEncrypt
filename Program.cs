...
namespace PDFEncrypt
{
    static class Program
    {
        ...
        public class Options
        {
            ...
            [Option("run",
                HelpText = "Run the encryption immediately upon startup (don't require user to click Encrypt button)")]
            ...
            // This function is called if the CommandLine.Parser succeeds in parsing all command line options.
        {
            ...
            else
            {
                ...
                var extension = System.IO.Path.GetExtension(opts.InputFile);
                if (outputFile == null || extension!= null)
                {
                    var result = outputFile.Substring(0, outputFile.Length - extension.Length);
                    form.txtOutputFile.Text = result + "_encrypted" + extension;
                }
            }
            ...
            // It should output error messages to CLI and/or desktop.
        {
            ...
            MessageBox.Show("Invalid command line options: " + errors.ToString(), "Error", MessageBoxButtons.OK,
